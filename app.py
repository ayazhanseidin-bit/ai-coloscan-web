...
st.markdown("""
    ...
    /* ЗАГОЛОВКИ НАД ФОТО (Теперь темно-серые, как secondary text) */
    .img-label {
        text-align: center;
        font-size: 16px;
        font-weight: 600;
        margin-bottom: 12px;
        color: var(--text-color-secondary); /* Используем стандартный secondary text color Streamlit */
        display: block;
...
with tab_team:
    ...
    with text_col:
        ...
        **Биологическая научная сборная iGEM Назарбаев Университета (НУ)** — это команда молодых ученых, представляющая Казахстан и Центральную Азию на международной arena уже 12 лет. За это время мы завоевали **6 золотых**, **2 серебряные** и **2 бронзовые медали**, подтверждая высокий уровень отечественной науки.
