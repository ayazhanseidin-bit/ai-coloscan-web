...
with tab_kvasir:
    ...
    Это верифицированная коллекция медицинских изображений из госпиталя **Vestre Viken (Норвегия)**, аннотированная опытными врачами-эндоскопистами.
    
    **Ключевые особенности:**
    * **Медицинская точность:** Каждое изображение проверено экспертами для гарантии правильной классификации.
    * **Многопрофильность:** Включает данные о полипах, воспалениях (язвенный колит, эзофагит) и важных анатомических ориентирах ЖКТ.
    * **Научный стандарт:** Использование Kvasir позволяет достичь высокой воспроизводимости результатов в клинических условиях.
    """)

with tab_about:
    st.header("iGEM Nazarbayev University")
    st.write("Студенческий проект по интеграции ИИ в систему здравоохранения Казахстана.")
