...
with tab_diag:
    ...
    if uploaded_file:
        ...
        # Сетка 1x2 для фото с текстовыми метками над ними
        c1, c2 = st.columns(2)
        with c1:
        ...
        # ТЕКСТ ПЕРЕД ДАННЫМИ
        st.markdown('<div class="estimation-disclaimer">The following clinical indicators are an Estimation of AI.</div>', unsafe_allow_html=True)
